...
This is the database model for users. It maps to the users table.
For business logic, use UserEntity instead.
"""
...
class User(Base):
    ...
    postal_code = Column(String(10), nullable=True, index=True)  # PIN code
    ...
    wahoo_connection = relationship("WahooConnection", back_populates="user", uselist=False)
