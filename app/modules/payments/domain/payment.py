...
class Payment(Base):
    ...
    )  # Use RefundStatus enum (PENDING, PROCESSED, FAILED)
    ...
    refund_speed_processed = Column(
        String(20), nullable=True
    )  # Actual refund speed used by gateway
