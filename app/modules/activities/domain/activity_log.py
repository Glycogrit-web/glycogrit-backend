"""
User Activity Log Model - SQLAlchemy ORM

Tracks user daily activity submissions for virtual challenges.
For business logic, use ActivityEntity instead.
"""
...
class UserActivityLog(Base):
    """UserActivityLog model - tracks user daily activity submissions"""
