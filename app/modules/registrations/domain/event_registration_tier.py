...
class EventRegistrationTier(Base):
    ...
    )  # 0=Free, 1=Basic, 2=Premium (for sorting and upgrade logic)
    ...
    reserved_spots = Column(
        Integer, nullable=False, default=0
    )  # Reserved spots during payment processing
    ...
    registration_tiers = relationship(
        "RegistrationTier", back_populates="tier", foreign_keys="RegistrationTier.tier_id"
    )
