...
down_revision: str | None = "ee92ac1e10d4"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_payments_gateway_order_id"), "payments", ["gateway_order_id"], unique=False
    )
    op.create_index(
        op.f("ix_payments_gateway_payment_id"), "payments", ["gateway_payment_id"], unique=False
    )
