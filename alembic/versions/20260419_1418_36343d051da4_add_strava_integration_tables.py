...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_strava_connections_athlete_id'), 'strava_connections', ['athlete_id'], unique=True)
    ...
    op.create_index(op.f('ix_challenge_activities_activity_date'), 'challenge_activities', ['activity_date'], unique=False)
    op.create_index(op.f('ix_challenge_activities_id'), 'challenge_activities', ['id'], unique=False)
    op.create_index(op.f('ix_challenge_activities_strava_activity_id'), 'challenge_activities', ['strava_activity_id'], unique=True)
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='event_sponsors_event_id_fkey', ondelete='CASCADE'),
    ...
    op.create_table('event_checkpoints',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('event_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('checkpoint_number', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('distance_from_start', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=True),
    ...
    sa.Column('elevation', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='event_checkpoints_event_id_fkey', ondelete='CASCADE'),
    ...
    op.drop_index(op.f('ix_challenge_activities_strava_activity_id'), table_name='challenge_activities')
