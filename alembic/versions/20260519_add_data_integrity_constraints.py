...
def upgrade():
    ...
    op.create_check_constraint(
        "ck_tier_price_non_negative", "event_registration_tiers", "price >= 0"
    )

    # Constraint: tier_order must be non-negative
    op.create_check_constraint(
        "ck_tier_order_non_negative", "event_registration_tiers", "tier_order >= 0"
    )
    ...
    op.create_check_constraint("ck_payment_amount_non_negative", "payments", "amount >= 0")
    ...
    op.create_check_constraint(
        "ck_registration_total_amount_paid_non_negative", "registrations", "total_amount_paid >= 0"
    )
    ...
    op.create_check_constraint(
        "ck_registration_age_positive", "registrations", "age IS NULL OR age > 0"
    )
    ...
    op.create_check_constraint(
        "ck_event_current_participants_non_negative", "events", "current_participants >= 0"
    )
...
def downgrade():
    ...
    op.drop_constraint(
        "ck_registration_confirmed_at_after_registered", "registrations", type_="check"
    )
    ...
    op.drop_constraint(
        "ck_registration_successful_payments_count_non_negative", "registrations", type_="check"
    )
    op.drop_constraint(
        "ck_registration_last_payment_amount_non_negative", "registrations", type_="check"
    )
    op.drop_constraint(
        "ck_registration_total_amount_paid_non_negative", "registrations", type_="check"
    )
    ...
    op.drop_constraint(
        "ck_tier_requires_payment_consistency", "event_registration_tiers", type_="check"
    )
    ...
    op.drop_constraint(
        "ck_tier_max_registrations_positive", "event_registration_tiers", type_="check"
    )
    op.drop_constraint(
        "ck_tier_current_registrations_non_negative", "event_registration_tiers", type_="check"
    )
