...
def upgrade() -> None:
    ...
    op.alter_column("fitness_tracker_connections", "provider_data", new_column_name="athlete_data")


def downgrade() -> None:
    """Rollback: Rename athlete_data back to provider_data"""
    op.alter_column("fitness_tracker_connections", "athlete_data", new_column_name="provider_data")
