...
def upgrade():
    ...
    op.create_index(
        "idx_event_registration_tiers_event_id",
        "event_registration_tiers",
        ["event_id"],
        unique=False,
    )
    op.create_index(
        "idx_event_registration_tiers_tier_slug",
        "event_registration_tiers",
        ["tier_slug"],
        unique=False,
    )
    op.create_index(
        "idx_event_registration_tiers_is_active",
        "event_registration_tiers",
        ["is_active"],
        unique=False,
    )
    ...
    op.create_unique_constraint(
        "uq_event_tier_slug", "event_registration_tiers", ["event_id", "tier_slug"]
    )
    op.create_unique_constraint(
        "uq_event_tier_order", "event_registration_tiers", ["event_id", "tier_order"]
    )

    # Create foreign key for event_registration_tiers
    op.create_foreign_key(
        "fk_event_registration_tiers_event",
        "event_registration_tiers",
        "events",
        ["event_id"],
        ["id"],
    ...
    op.create_index(
        "idx_registration_tiers_registration_id",
        "registration_tiers",
        ["registration_id"],
        unique=False,
    )
    op.create_index(
        "idx_registration_tiers_tier_id", "registration_tiers", ["tier_id"], unique=False
    )

    # Create unique constraint for registration_tiers
    op.create_unique_constraint(
        "uq_registration_tier", "registration_tiers", ["registration_id", "tier_id"]
    )

    # Create foreign keys for registration_tiers
    op.create_foreign_key(
        "fk_registration_tiers_registration",
        "registration_tiers",
        "registrations",
        ["registration_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_registration_tiers_upgraded_from",
        "registration_tiers",
        "event_registration_tiers",
        ["upgraded_from_tier_id"],
        ["id"],
    )
    op.create_foreign_key(
        "fk_registration_tiers_upgrade_payment",
        "registration_tiers",
        "payments",
        ["upgrade_payment_id"],
        ["id"],
    ...
    op.add_column(
        "events",
        sa.Column("uses_tier_system", sa.Boolean(), nullable=False, server_default="false"),
    )
    ...
    op.create_foreign_key(
        "fk_events_default_tier", "events", "event_registration_tiers", ["default_tier_id"], ["id"]
    )
    ...
    op.create_index(
        "idx_registrations_current_tier_id", "registrations", ["current_tier_id"], unique=False
    )
    op.create_foreign_key(
        "fk_registrations_current_tier",
        "registrations",
        "event_registration_tiers",
        ["current_tier_id"],
        ["id"],
    ...
    op.add_column(
        "payments",
        sa.Column("is_tier_upgrade", sa.Boolean(), nullable=False, server_default="false"),
    )

    # Create index and foreign key for payments.tier_id
    op.create_index("idx_payments_tier_id", "payments", ["tier_id"], unique=False)
    op.create_foreign_key(
        "fk_payments_tier", "payments", "event_registration_tiers", ["tier_id"], ["id"]
    )
...
def downgrade():
    ...
    op.drop_constraint(
        "fk_registration_tiers_upgrade_payment", "registration_tiers", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_registration_tiers_upgraded_from", "registration_tiers", type_="foreignkey"
    )
    op.drop_constraint("fk_registration_tiers_tier", "registration_tiers", type_="foreignkey")
    op.drop_constraint(
        "fk_registration_tiers_registration", "registration_tiers", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_event_registration_tiers_event", "event_registration_tiers", type_="foreignkey"
    )
