...
def upgrade() -> None:
    ...
    op.create_index('ix_event_activities_registration_id', 'event_activities', ['registration_id'], unique=False)
    op.create_index('ix_event_activities_activity_date', 'event_activities', ['activity_date'], unique=False)
