...
down_revision: str | None = "20260502_shiprocket"
...
def upgrade() -> None:
    ...
    op.add_column(
        "registrations", sa.Column("shipping_address_line1", sa.String(255), nullable=True)
    )
    op.add_column(
        "registrations", sa.Column("shipping_address_line2", sa.String(255), nullable=True)
    )
    ...
    op.add_column(
        "registrations",
        sa.Column("shipping_country", sa.String(100), nullable=True, server_default="India"),
    )
